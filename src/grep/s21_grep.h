...
int strlist_push_back(t_strlist **head, char *content, int make_copy);
int strlist_insert_sort(t_strlist **head, char *content, int make_copy);
...
int get_options(int argc, char *argv[], t_strlist **template,
                t_strlist **filename);
